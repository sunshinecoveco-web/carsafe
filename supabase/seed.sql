...
DECLARE
  -- Owner
  owner1 UUID := '00000000-0000-0000-0002-000000000001';

  -- Dealers (DB UUID → the TEXT string stored in approved_dealer_ids matches localStorage auth)
...
BEGIN
  ...
  INSERT INTO public.owners (id, name, email, role) VALUES
    (owner1, 'Demo Owner', 'owner@carsafe.co.za', 'owner')
  ...
  -- ── Service logs ──────────────────────────────────────────────────────────
  -- "workshop" is the existing column that maps to servicedBy in the app.
  -- "parts" is TEXT storing a JSON string.
  ...
  VALUES
    (v1,'2024-08-15T10:00:00Z','dealer-1','Service Added','10,000km Service','8f2c3d...','a1b2c3...'),
    (v1,'2024-04-10T14:30:00Z','dealer-1','Service Added','Brake pads','a1b2c3...','b2c3d4...'),
    (v1,'2023-12-10T09:00:00Z','dealer-1','Service Added','Inspection','b2c3d4...','000000...'),

    (v2,'2024-02-20T11:00:00Z','dealer-2','Service Added','Inspection','9e3d4f...','b2c3d4...'),
    (v2,'2023-08-15T10:00:00Z','dealer-2','Service Added','Tyre rotation','b2c3d4...','c3d4e5...'),
    (v2,'2023-02-15T10:00:00Z','dealer-2','Service Added','Minor Service','c3d4e5...','000000...'),

    (v3,'2024-03-01T10:00:00Z','owner-1','Ownership Transferred','Marked for sale','1a2b3c...','c3d4e5...'),
    (v3,'2024-01-22T13:00:00Z','dealer-3','Service Added','Oil Change','c3d4e5...','d4e5f6...'),
    (v3,'2023-01-15T10:00:00Z','dealer-3','Service Added','Full Service','d4e5f6...','000000...'),

    (v4,'2024-09-01T09:15:00Z','dealer-4','Service Added','Claim Assessment','2b3c4d...','d4e5f6...'),
    (v4,'2024-03-10T10:00:00Z','dealer-4','Service Added','Microfilter','d4e5f6...','e5f6g7...'),
    (v4,'2023-09-15T10:00:00Z','dealer-4','Service Added','Brake fluid','e5f6g7...','000000...'),

    (v5,'2024-05-15T10:00:00Z','dealer-1','Service Added','Brake Service','3c4d5e...','e5f6g7...'),
    (v5,'2023-11-10T10:00:00Z','dealer-1','Service Added','Wipers','e5f6g7...','f6g7h8...'),
    (v5,'2023-05-10T11:00:00Z','dealer-1','Service Added','Service A','f6g7h8...','000000...'),

    (v6,'2024-07-15T10:00:00Z','dealer-1','Service Added','Alignment','4d5e6f...','f5g6h7...'),
    (v6,'2024-01-15T10:00:00Z','dealer-1','Service Added','Oil change','f5g6h7...','g6h7i8...'),
    (v6,'2023-11-20T10:00:00Z','system','Vehicle Created','Initial Registry','g6h7i8...','000000...'),

    (v7,'2024-03-10T10:00:00Z','dealer-2','Service Added','15k Service','5e6f7g...','g6h7i8...'),
    (v7,'2023-09-05T14:00:00Z','dealer-2','Service Added','Battery','g6h7i8...','h7i8j9...'),
    (v7,'2022-05-15T10:00:00Z','system','Vehicle Created','New Entry','h7i8j9...','000000...'),

    (v8,'2023-12-01T10:00:00Z','owner-1','Ownership Transferred','Listed for sale','6f7g8h...','h7i8j9...'),
    (v8,'2021-01-10T10:00:00Z','system','Vehicle Created','Registration','h7i8j9...','000000...'),

    (v9,'2024-08-10T11:00:00Z','dealer-1','Service Added','Accessories','7g8h9i...','i8j9k0...'),
    (v9,'2024-05-20T10:00:00Z','dealer-1','Service Added','Health check','i8j9k0...','j9k0l1...'),
    (v9,'2024-01-20T10:00:00Z','system','Vehicle Created','New Vehicle','j9k0l1...','000000...'),

    (v10,'2024-06-15T10:00:00Z','dealer-3','Service Added','First Service','8h9i0j...','j9k0l1...'),
    (v10,'2024-02-10T09:00:00Z','dealer-3','Service Added','Software','j9k0l1...','k0l1m2...'),
    (v10,'2023-06-15T10:00:00Z','system','Vehicle Created','Initial Registry','k0l1m2...','000000...'),

    (v11,'2024-07-20T10:00:00Z','dealer-3','Service Added','Spark plugs','9i0j1k...','k0l1m2...'),
    (v11,'2024-03-05T10:00:00Z','dealer-3','Service Added','System update','k0l1m2...','l1m2n3...'),
    (v11,'2023-09-01T10:00:00Z','system','Vehicle Created','New Arrival','l1m2n3...','000000...'),

    (v12,'2024-01-10T10:00:00Z','dealer-1','Service Added','Routine service','0j1k2l...','l1m2n3...'),
    (v12,'2023-07-15T11:00:00Z','dealer-1','Service Added','Diff oil','l1m2n3...','m2n3o4...'),
    (v12,'2022-01-10T10:00:00Z','system','Vehicle Created','Registration','m2n3o4...','000000...'),

    (v13,'2024-09-10T10:00:00Z','dealer-2','Service Added','Wipers','1k2l3m...','m2n3o4...'),
    (v13,'2024-05-10T10:00:00Z','dealer-2','Service Added','First service','m2n3o4...','n3o4p5...'),
    (v13,'2023-05-05T10:00:00Z','system','Vehicle Created','New Entry','n3o4p5...','000000...'),

    (v14,'2024-08-20T10:00:00Z','dealer-1','Service Added','Air filter','2l3m4n...','n3o4p5...'),
    (v14,'2024-04-12T10:00:00Z','dealer-1','Service Added','45k Service','n3o4p5...','o4p5q6...'),
    (v14,'2021-04-12T10:00:00Z','system','Vehicle Created','Initial Setup','o4p5q6...','000000...'),

    (v15,'2024-09-10T10:00:00Z','dealer-2','Service Added','Claim assessment','3m4n5o...','o4p5q6...'),
    (v15,'2024-06-01T10:00:00Z','dealer-2','Service Added','Oil top-up','o4p5q6...','p5q6r7...'),
